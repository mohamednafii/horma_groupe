...
import { gommageAkarFasi } from "@/components/landing-pages/gommage-akar-fasi/content";

/* Tajawal is the landing page's face only. Loading it here rather than in the
...
export const metadata: Metadata = {
  ...
  description:
    "مقشر العكر الفاسي من الحرة: خلطة مغربية طبيعية 100% بزيت الأركان وزبدة الشيا وجوز الهند وزيت الزيتون. الدفع عند الاستلام وتوصيل سريع لجميع المدن.",
  openGraph: {
    type: "website",
    locale: "ar_MA",
    title: "مقشر العكر الفاسي من الحرة — سر الجمال المغربي",
    description:
      "خلطة مغربية طبيعية 100% للعناية بالبشرة. الدفع عند الاستلام وتوصيل سريع لجميع المدن.",
    images: [{ url: gommageAkarFasi.brand.ogImage, width: 1200, height: 630 }],
  },
 ...
 */
export default function GommageAkarFasiLayout({ children }: LayoutProps<"/lp/gommage_akar_fasi">) {
  return (
